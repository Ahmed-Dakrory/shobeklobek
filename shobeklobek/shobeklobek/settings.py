"""
Django settings for shobeklobek project.
...
SECRET_KEY = 'y#3$-pk-)q-$!1!1l&0p$hw%8&i4#^-9+3n#n)mzp@(_k3e00a'
...
WSGI_APPLICATION = 'shobeklobek.wsgi.application'
